...
import com.server.model.QuoteList;
import com.server.model.StockInfo;
import com.server.repository.PersonRepository;
import com.server.repository.quote.QuoteRepository;
import com.server.repository.stockinfo.StockInfoRepository;
...
public class RabbitMarketDataGateway implements MarketDataGateway {
    ...
    @Autowired
    private com.server.RedisHashMapping redisHashMapping;
