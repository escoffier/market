...
import com.server.converter.AddressToBytesConverter;
import com.server.converter.BytesToAddressConverter;
import com.server.converter.QuoteConverter;
import com.server.converter.QuoteListConverter;
...
@Configuration
@EnableRedisRepositories(basePackages = {"com.stock.repository", "com.server.converter"})
